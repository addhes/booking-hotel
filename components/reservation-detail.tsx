...
const ReservationDetail = async ({
    ...
    if(!reservation) return notFound();1
                ...
                <li className='py-2'>
                    <div className='flex items-center'>
                        ...
                        <div className='inline-flex items-center text-base font-semibold text-gray-900 capitalize'>
                            {reservation.Payment?.method ? reservation.Payment.method.replace("_", " "): null}
                        </div>
                    </div>
                </li>
                <li className='py-2'>
            ...
            <table className='w-full text-sm text-left text-gray-500'>
                <thead className='text-xs text-gray-700 uppercase bg-gray-50'>
                    <tr>
                        ...
                        <th className='px-6 py-3'>Depature</th>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td className='px-6 py-3 text-right' colSpan={3}>{reservation.Payment && formatCurrency(reservation.Payment.amount)}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
