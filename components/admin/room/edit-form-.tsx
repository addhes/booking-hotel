...
const EditFormPage = ({
  ...
  const handleUpload = () => {
    // jika tidak terdapat input file diref
    if (!inputFileRef.current?.files) return null;
    // Jika input ref image ada
            ...
            >
              ...
              {image ? (
                <button
                  ...
                  className="flex items-center justify-center size-6 rounded-sm absolute right-1
                    top-1 text-white bg-red-300 hover:bg-red-500 "
                >
                  <IoTrashOutline className="size-4  hover:text-white cursor-pointer" />
                </button>
              ) : (
