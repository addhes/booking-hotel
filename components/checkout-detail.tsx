        ...
        <div className='order-2'>
            <div className='flex flex-col mb-3 items-start bg-white border border-gray-200 rounded-sm md:flex-row md:w-full'>
                <div className=' aspect-video relative'>
                    <Image src={reservation.Room.image} width={500} height={300}
                    className='object-cover w-full rounded-t-sm aspect-video md:rounded-none md:rounded-s-sm' alt='room image' />
                </div>
                <div className='flex flex-col justify-between p-4 leading-normal w-full'>
                    <h5 className='mb-1 text-3xl font-bold tracking-tight text-gray-900'>{reservation.Room.name}</h5>
